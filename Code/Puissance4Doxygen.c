...
*/
#define COLONNE_DEBUT 3  //colonne de debut pour commencer au milieu du tableau pour choisirColonne
...
*/
#define LIG_DEBUT 5 //Ligne de debut, Permet de commencer en bas du tableau
